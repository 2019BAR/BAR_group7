...
table(ts[D$Arrest] > as.POSIXct(median(ts)))#
#
```
...
```{r}
ts[D$LocationDescription=="DRIVEWAY - RESIDENTIAL"] %>% format('%u')  %>% table %>% sort
```
